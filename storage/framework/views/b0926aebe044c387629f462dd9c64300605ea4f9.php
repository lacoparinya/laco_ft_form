<div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
    ...
    <input class="form-control" name="name" type="text" id="name" value="<?php echo e(isset($unit->name) ? $unit->name : ''); ?>" >
...
<div class="form-group <?php echo e($errors->has('desc') ? 'has-error' : ''); ?>">
    ...
    <input class="form-control" name="desc" type="text" id="desc" value="<?php echo e(isset($unit->desc) ? $unit->desc : ''); ?>" >
