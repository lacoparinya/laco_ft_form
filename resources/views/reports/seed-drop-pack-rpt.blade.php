...
<div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">รายงานถั่วตกไลน์แพ๊คตั้งแต่วันที่ถึงวันที่</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/reports/seedDropPackReportAction') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
