...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h3>แก้ไขรายการในงานเตรียมการ #{{ $logprepared->id }}</h3></div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/log-prepare-ms/updateDetail/' . $logprepared->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('log-prepare-ms.form-detail', ['formMode' => 'edit'])
