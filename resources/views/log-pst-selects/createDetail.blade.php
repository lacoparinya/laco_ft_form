...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h3>สร้างรายการในงานคัด</h3></div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/log-pst-selects/storeDetail/'.$logpstselectm->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('log-pst-selects.form-detail', ['formMode' => 'create'])
