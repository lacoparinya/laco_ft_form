...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">สร้างรายการในงานPack</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/log-pack-ms/storeDetail/'.$logpackm->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('log-pack-ms.form-detail', ['formMode' => 'create'])
