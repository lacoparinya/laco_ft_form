                                ...
                                @foreach($packagings as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/pack_papers/generateOrder/'.$item->id.'/1') }}" title="สร้างใบแจ้งบรรจุ" class="btn btn-info btn-sm"><i class="fa fa-file-text-o" aria-hidden="true"></i> ใบแจ้งบรรจุ</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
