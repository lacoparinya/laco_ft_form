...
@section('content')
 ...
 <br />
    ...
    @if(isset($logpackm->shift->name))
      title : '{{ $logpackm->method->name }} - {{ $logpackm->package->name }} - อัตราการผลิตสะสมวันที่ {{ $logpackm->process_date }} - กะ {{ $logpackm->shift->name }}',
    @else 
      title : '{{ $logpackm->method->name }} - {{ $logpackm->package->name }} - อัตราการผลิตสะสมวันที่ {{ $logpackm->process_date }}',
    @endif
