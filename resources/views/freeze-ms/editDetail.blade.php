...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h3>แก้ไขรายการงานฟรีส #{{ $freezem->id }}</h3></div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/freeze-ms/updateDetail/' . $freezed->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('freeze-ms.form-detail', ['formMode' => 'edit'])
